          ...
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            <form action="/bookCustServlet" method="POST" class="bg-white p-md-5 p-4 mb-5 border">
               ...
               <div class="col-md-6 form-group">
                ...
                <input type="text" id="custFName" name="custFName" class="form-control">

               </div>
                <div class="col-md-6 form-group">
                <label class="text-black font-weight-bold" for="custLName">Last Name</label>
                <input type="text" id="custLName" name="custLName" class="form-control">
                </div>
            
                <div class="col-md-6 form-group">
                  <label class="text-black font-weight-bold" for="custPhoneNumber">Phone</label>
                  <input type="text" id="custPhoneNumber" name="custPhoneNumber" class="form-control ">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="email" id="custEmail" name="custEmail" class="form-control ">
                </div>
              </div>
